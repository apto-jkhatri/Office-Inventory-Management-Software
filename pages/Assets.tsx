...
const DEFAULT_CATEGORIES = ['Laptop', 'Monitor', 'Keyboard', 'Mobile', 'Server'];
...
const Assets = () => {
  ...
  const handleSaveSubmit = (e: React.FormEvent) => {
    ...
    const baseSerial = formData.get('serial') as string;
    ...
    if (editingAsset) {
      ...
      for (let i = 0; i < qtyToCreate; i++) {
        ...
        const newAsset: Asset = {
          ...
          tag: `${baseTag}${suffix}`,
          serialNumber: `${baseSerial}${suffix}`,
        };
        addAsset(newAsset);
      }
    }
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500">Manage all hardware and software assets inventory.</p>
        </div>
        <button 
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-slate-500 text-xs">{asset.vendor}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="font-mono text-xs text-slate-600 bg-slate-100 px-2 py-1 rounded w-fit mb-1">{asset.tag}</div>
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden my-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveSubmit} className="p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedCategory === 'Other' && (
                      <input 
                        ...
                        className="w-full px-3 py-2 border border-blue-300 bg-blue-50 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-blue-900 placeholder-blue-300" 
                      />
                    )}
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">
                    Serial Number {showQuantity && quantity > 1 && <span className="text-xs text-slate-400 font-normal">(Base)</span>}
                  </label>
                  <input 
                    required 
                    name="serial" 
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button type="submit" className="px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 shadow-md shadow-blue-500/30">
