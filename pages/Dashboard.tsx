...
import { Box, Wrench, Users, ArrowUpRight, ArrowDownRight, FilterX } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatCard title="Total Assets" value={totalAssets} icon={Box} color="bg-blue-500" trend={12} />
        <StatCard title="Assigned Assets" value={globalAssigned} icon={Users} color="bg-indigo-500" trend={8} />
        <StatCard title="In Repair" value={globalInRepair} icon={Wrench} color="bg-amber-500" trend={-2} />
      </div>
