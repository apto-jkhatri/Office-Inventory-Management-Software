...
export const INITIAL_ASSETS: Asset[] = [
  ...
  { id: 'A003', tag: 'AST-1003', name: 'LG UltraFine 5K', serialNumber: 'LG-998877', category: 'Monitor', vendor: 'LG', purchaseDate: '2023-02-01', cost: 1299, status: AssetStatus.AVAILABLE, condition: AssetCondition.NEW, location: 'IT Storage' },
...
export const INITIAL_REQUESTS: AssetRequest[] = [
  { id: 'R-001', employeeId: 'E003', category: 'Monitor', reason: 'Need second screen for design work', status: 'Pending', requestDate: '2023-10-26' },
];